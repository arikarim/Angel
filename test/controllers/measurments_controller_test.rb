...
class MeasurmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measurment" do
    assert_difference('Measurment.count') do
      post measurments_url, params: { measurment: { date: @measurment.date, measure_id: @measurment.measure_id, number: @measurment.number, user_id: @measurment.user_id } }, as: :json
    end
  ...
  test "should update measurment" do
    patch measurment_url(@measurment), params: { measurment: { date: @measurment.date, measure_id: @measurment.measure_id, number: @measurment.number, user_id: @measurment.user_id } }, as: :json
    assert_response 200
  end
